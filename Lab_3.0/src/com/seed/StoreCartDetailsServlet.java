...
public class StoreCartDetailsServlet extends HttpServlet
{
	...
	String[] userRequestBook = request.getParameterValues("bookID");

	// TODO:5 add these product ids in the ShoppingCart object referenced by
	// "cartRef" local variable

	if (userRequestBook != null && userRequestBook.length != 0)
	{
	    cartRef.setProductList(userRequestBook);
	}
	...
	{
	    RequestDispatcher reqDispatcher = request.getRequestDispatcher("displayDetails");
